...
* DONE [#A] Blog: setup mac workstation                           :IMPORTANT:
  CLOSED: [2017-12-03 Sun 23:05]

bash ~/Dropbox/private_data/emacs_stuff/backup_small/setup_mac.sh
...
** DONE chrome undo closed tab: Command + Shift + T
   CLOSED: [2017-12-01 Fri 18:03]
** #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* [#A] Apple mac OSX                                         :Linux:Personal:
:PROPERTIES:
:type:   Tool
:END:
